...
/**
 * Static layout has main project information 
 *
 * @author Yehia Farag
 *
 *
...
public class WelcomeLayout extends VerticalLayout implements Serializable {
    ...
    public WelcomeLayout() {
        ...
        WelcomeLayout.this.setWidth(100, Unit.PERCENTAGE);
        HorizontalLayout mainBodyHLayout = new HorizontalLayout();
        mainBodyHLayout.setWidth(100, Unit.PERCENTAGE);
        WelcomeLayout.this.addComponent(mainBodyHLayout);
        ...
        Label para_6 = new Label("<p class='linkwithimg' align='justify' Style='margin-left:40px;color:#585858;'><font size=\"2\"><a class='link'style='font-size: 15px !important; color: #4d749f;font-weight: 500;' href='https://proteomics.uib.no/csf-pr/' target=\"_blank\"><img class='smallimgicon' src='VAADIN/themes/dario-theme/img/scatter_plot_applied.png' alt='CSF-PR Quant'>For protein quantitative data data visit CSF-PR <font size=\"1.5\">v2.0</font></a>.</font></p>");
