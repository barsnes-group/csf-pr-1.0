...
/**
 *This class represents protein layout container
 * @author Yehia Farag
 */
...
//    private CustomExternalLink proteinLabel;
    ...
    private ClickableIconGenerator iconGenerator = new ClickableIconGenerator();
    ...
    /**
     * Initialise main proteins tab layout initialise drop down select dataset
     * list and add main value change listener to it
     */
    private void buildMainLayout() {
        VerticalLayout vlo = new VerticalLayout();
        vlo.setStyleName(Reindeer.LAYOUT_WHITE);
        vlo.setHeight(70,Unit.PIXELS);
        ...
        if (handler.getDatasetList() == null || handler.getDatasetList().isEmpty()) {
            ...
            selectDatasetLabel.setHeight(35,Unit.PIXELS);
            ...
            selectDatasetListLayout.setWidth(100,Unit.PERCENTAGE);
            ...
            selectDataset.setWidth(90,Unit.PERCENTAGE);
            selectDataset.setNullSelectionAllowed(false);
            ...
            infoLable.setWidth(450,Unit.PIXELS);
            iconGenerator = new ClickableIconGenerator();
            HorizontalLayout infoIco = iconGenerator.generateInformationNote(infoLable);
        ...
        if (selectedDatasetKey != null && (!selectedDatasetKey.toString().equals(defaultSelectString))) {
            ...
            if (handler.getMainDataset() != null && handler.getMainDataset().getDatasetType() == 1) {
                ...
                if (datasetDetailsLayout != null) {
                    visability = datasetDetailsLayout.isExpanded();
...
//                        }
                        ...
                        fractionLayout.setWidth(100,Unit.PERCENTAGE);
                        //peptide layout
                        ...
                        peptideLayout.setWidth(100,Unit.PERCENTAGE);
...
//                        proteinLabel.rePaintLable("white");
                        ...
                        if (proteinskey >= 0) {
                            ...
                            if (!peptideProteintList.isEmpty()) {
                                ...
                                peptideTableLayout.setExportBtnForPeptideTable(ExportDatasetProtenPeptidesLayout);
